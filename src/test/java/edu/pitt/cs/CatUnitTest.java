...
public class CatUnitTest {
	...
	public void testGetName() {
		...
		assertEquals("Cat name is not Jennyanydots", ret, "Jennyanydots");
	}
	...
	public void testGetRented() {
		...
		assertEquals("Cat name is not false", false, ret);
	}
	...
	public void testToString() {
		...
		assertEquals("Cat name is not ID 1. Jennyanydots", "ID 1. Jennyanydots",ret);
	}
	...
	public void testRentCat() {
		c.rentCat();
		boolean ret = c.getRented();
		assertEquals("Cat after renting is not true", true,ret);
	}
	...
	public void testReturnCat() {
		...
		c.returnCat();
		boolean ret = c.getRented();
		assertEquals("Cat after returning is not false", false,ret);
	}
	...
	public void testRenameCat() {
		...
		String ret = c.getName();
		assertEquals("Cat name is not Garfield","Garfield",ret);
	}
